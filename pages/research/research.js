...
const projects = [
    [
        ...
        "../../resources/pollymer_flowchart.png",
        "2024 - Present",
        "<a href=\"https://vganesh1.github.io/\">Dr. Vijay Ganesh</a>",
        "<a href=\"https://www.linkedin.com/in/ignacio-di-leva\">Ignacio Di Leva</a>",
        "An LLM-based program invariant generation tool that consists of: <ul><li>Static analysis code transformations that pre-process the code</li><li>LLM that takes code as input and outputs a version with invariants</li><li>A feedback loop between the LLM and a verifier that allows the LLM to leverage in-context learning</li></ul>. This work is pending review at CAV '25."
    ],
    [
        ...
        "Arbalest is a dynamic analysis tool that detects OpenMP Data Mapping Violations. It instruments every single memory access on the host and kernel, but this is unnecessary. Static analysis can greatly reduce the amount of instrumented analysis calls."
    ],
    [
